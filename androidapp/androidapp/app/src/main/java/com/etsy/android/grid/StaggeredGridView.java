...
public class StaggeredGridView extends ExtendableListView {
    ...
    /**
     * The location of the bottom_common of each bottom_common item added in each column.
     */
...
//        super.onMeasure(widthMeasureSpec, expandSpec);
    ...
    private void preLayoutChildren() {
        ...
        // copy the tops into the bottom_common
    ...
    private void layoutGridHeaderFooter(final View child, final int position, final boolean flowDown, final int childrenLeft, final int childTop, final int childRight, final int childBottom) {
        // offset the top and bottom_common of all our columns
        // if it's the footer we want it below the lowest child bottom_common
        int gridChildTop;
        int gridChildBottom;
    ...
    private void layoutGridChild(final View child, final int position,
        ...
        // stash the bottom_common and the top if it's higher positioned
        ...
        if (flowDown) {
            gridChildTop = mColumnBottoms[column]; // the next items top is the last items bottom_common
            gridChildBottom = gridChildTop + (getChildHeight(child) + verticalMargins);
        }
        else {
            gridChildBottom = mColumnTops[column]; // the bottom_common of the next column up is our top
    ...
    /**
     * Get the bottom_common for the next child up in our view
    ...
    protected void onChildrenDetached(final int start, final int count) {
        ...
        // go through our remaining views and sync the top and bottom_common stash.

        // Repair the top and bottom_common column boundaries from the views we still have
    ...
    private void onColumnSync() {
        ...
        for (int pos = 0; pos < syncPosition; pos++) {
            ...
            if (isHeaderOrFooter(pos)) {
                // the next top is the bottom_common for that column
    ...
    private int getHighestPositionedBottomColumn() {
        ...
        // the highest positioned bottom_common is the one with the lowest value :D
        for (int i = 0; i < mColumnCount; i++) {
    ...
    private int getLowestPositionedBottomColumn() {
        ...
        // the lowest positioned bottom_common is the one with the highest value :D
        for (int i = 0; i < mColumnCount; i++) {
            int bottom = mColumnBottoms[i];
