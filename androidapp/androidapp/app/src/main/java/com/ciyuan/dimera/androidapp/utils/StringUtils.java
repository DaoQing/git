...
public class StringUtils {
     ...
     * @param lineCount
     */
    public static void cutStringByLine(final TextView tv,String text, final int lineCount) {
        ...
        observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (tv.getLineCount() > lineCount) {   //判断行数大于多少时改变
                    int lineEndIndex = tv.getLayout().getLineEnd(lineCount-1); //设置第六行打省略号
