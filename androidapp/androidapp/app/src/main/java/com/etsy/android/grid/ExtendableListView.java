...
public abstract class ExtendableListView extends AbsListView {
     ...
     * or a footer at the bottom_common.
     */
    ...
    /**
     * Add a fixed view to appear at the bottom_common of the list. If addFooterView is
     * called more than once, the views will appear in the order they were
     * added. Views added using this call can take focus if they want.
     * <p/>
     * NOTE: Call this before calling setAdapter. This is so ListView can wrap
    ...
    /**
     * Add a fixed view to appear at the bottom_common of the list. If addFooterView is called more
...
//            case TOUCH_MODE_OVERSCROLL:
    ...
    private boolean onTouchUpScrolling(final MotionEvent event) {
        if (hasChildren()) {
            // 2 - Are we at the top or bottom_common?
    ...
    protected void fillGap(boolean down) {
        ...
        if (down) {
            ...
            // fill up from the bottom_common of the position above our first.
    ...
    /**
     * Fills the list from top to bottom_common, starting with mFirstPosition
     */
     ...
     * @param flowDown If true, align top edge to y. If false, align bottom_common
     *                 edge to y.
    ...
    /**
     * Check if we have dragged the bottom_common of the list too high (we have pushed the
    ...
    private void correctTooHigh(int childCount) {
        ...
        if (lastPosition == mItemCount - 1 && childCount > 0) {
            ...
            // ... and its bottom_common edge
            final int lastBottom = getLowestChildBottom();

            // This is bottom_common of our drawable area
            final int end = (getBottom() - getTop()) - getListPaddingBottom();

            // This is how far the bottom_common edge of the last view is from the bottom_common of the
            // drawable area
    ...
    /**
     * Check if we have dragged the bottom_common of the list too low (we have pushed the
     * bottom_common element off the bottom_common of the screen when we did not need to). Correct by sliding
     * everything back up.
     *
     * @param childCount Number of children
     */
    private void correctTooLow(int childCount) {
        ...
        // bottom_common of the list to be pushed down.
        if (mFirstPosition == 0 && childCount > 0) {
            ...
            // last row or the last row is scrolled off the bottom_common of the drawable area
            if (topOffset > 0) {
                if (lastPosition < mItemCount - 1 || lastBottom > end) {
                    if (lastPosition == mItemCount - 1) {
                        // Don't pull the bottom_common too far up
    ...
    /**
     * Make sure views are touching the top or bottom_common edge, as appropriate for
     * our gravity
     */
    ...
    /**
     * Override to set you custom listviews child to a bottom_common top location
     *
     * @return the bottom_common location to layout the child for the given position
     */
            ...
            switch (mTouchMode) {
                ...
                case TOUCH_MODE_FLINGING: {
                    ...
                    if (delta > 0) {
                        ...
                        // List is moving towards the bottom_common. Use last view as mMotionPosition
