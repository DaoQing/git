...
import com.ciyuan.dimera.androidapp.activity.ModelDetailAct;
...
public class ModelHolder extends BaseHolder<List<NewModelBean>>
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent=new Intent(mContext, ModelDetailAct.class);
    ...
    class GalleryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
          ...
          //  iv.setImageResource(R.drawable.gallery_01);
            ImageLoader.getInstance().displayImage("http://           " + mPictures.get(position).getModelgroup_picurl(), iv,getDefaultDisplayOptionOfNormal());
